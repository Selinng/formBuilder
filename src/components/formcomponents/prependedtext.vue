<template>
    <div class="form-group">
        <label class="col-sm-3 control-label">{{componentattr ? componentattr.title : defaultData.title}}</label>
        <div class="col-sm-9">
            <div class="input-group">
                <span class="input-group-addon">{{componentattr ? componentattr.addontext : defaultData.addontext}}</span>
                <input 
                    type="text" 
                    class="form-control" 
